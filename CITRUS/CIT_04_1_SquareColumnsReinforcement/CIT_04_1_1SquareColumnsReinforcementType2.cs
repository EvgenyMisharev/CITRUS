...
namespace CITRUS.CIT_04_1_SquareColumnsReinforcement
{
    ...
    class CIT_04_1_1SquareColumnsReinforcementType2 : IExternalCommand
    {
...
#region  Старт блока использования формы
            ...
            formSquareColumnsReinforcementType2.ShowDialog();
            if (formSquareColumnsReinforcementType2.DialogResult != System.Windows.Forms.DialogResult.OK)
            {
...
#region Старт блока Получение данных из формы
            ...
            RebarBarType mySecondMainRebarType = formSquareColumnsReinforcementType2.mySelectionSecondMainBarTape;
            //Выбор типа арматуры хомутов
            RebarBarType myStirrupBarTape = formSquareColumnsReinforcementType2.mySelectionStirrupBarTape;
            //Выбор типа защитного слоя основной арматуры
            RebarCoverType myRebarCoverType = formSquareColumnsReinforcementType2.mySelectionRebarCoverType;
            ...
            double floorThicknessAboveColumn = formSquareColumnsReinforcementType2.FloorThickness / 304.8;
            ...
            //Длина выпусков
            double rebarOutletsLength = formSquareColumnsReinforcementType2.RebarOutlets / 304.8;

            //Длина выпусков боковых стержней
            double rebarSecondOutletsLength = formSquareColumnsReinforcementType2.RebarSecondOutlets / 304.8;

            // Смещение первого хомута от низа колонны
            double firstStirrupOffset = formSquareColumnsReinforcementType2.FirstStirrupOffset / 304.8;

            // Учащенный шаг хомутов
            double increasedStirrupSpacing = formSquareColumnsReinforcementType2.IncreasedStirrupSpacing / 304.8;

            // Стандартный шаг хомутов
            double standardStirrupSpacing = formSquareColumnsReinforcementType2.StandardStirrupSpacing / 304.8;

            //Высота размещения хомутов с учащенным шагом
            double stirrupIncreasedPlacementHeight = formSquareColumnsReinforcementType2.StirrupIncreasedPlacementHeight / 304.8;
            int StirrupBarElemFrequentQuantity = (int)(stirrupIncreasedPlacementHeight / increasedStirrupSpacing) + 1;

            string checkedRebarOutletsButtonName = formSquareColumnsReinforcementType2.CheckedRebarOutletsButtonName;

            //Изменение сечения колонны
            bool changeColumnSection = formSquareColumnsReinforcementType2.СhangeColumnSection;

            //Переход со сварки на нахлест
            bool transitionToOverlap = formSquareColumnsReinforcementType2.TransitionToOverlap;

            //Заглубление стержней
            double deepeningBarsSize = 0;
            bool deepeningBars = formSquareColumnsReinforcementType2.DeepeningBars;
            if (deepeningBars == true)
            {
                deepeningBarsSize = formSquareColumnsReinforcementType2.DeepeningBarsSize / 304.8;
            }
            else
            {
                deepeningBarsSize = 0;
            ...
            //Загнуть в плиту
            bool bendIntoASlab = formSquareColumnsReinforcementType2.BendIntoASlab;
 ...
 #region Старт блока Получение типа элемента CIT_04_ВаннаДляСварки
            ...
            double sectionOffset = formSquareColumnsReinforcementType2.ColumnSectionOffset / 304.8;
