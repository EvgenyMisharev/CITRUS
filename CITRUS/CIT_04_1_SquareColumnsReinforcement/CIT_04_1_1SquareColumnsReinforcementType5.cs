...
namespace CITRUS.CIT_04_1_SquareColumnsReinforcement
{
    ...
    class CIT_04_1_1SquareColumnsReinforcementType5 : IExternalCommand
    {
...
#region  Старт блока использования формы
            ...
            //Вызов формы
            CIT_04_1_1FormSquareColumnsReinforcementType5 formSquareColumnsReinforcementType5 = new CIT_04_1_1FormSquareColumnsReinforcementType5(firstMainRebarTapesList, secondMainRebarTapesList, firstStirrupRebarTapesList, secondStirrupRebarTapesList, rebarCoverTypesList);
            formSquareColumnsReinforcementType5.ShowDialog();
            if (formSquareColumnsReinforcementType5.DialogResult != System.Windows.Forms.DialogResult.OK)
            {
...
#region Старт блока Получение данных из формы
            ...
            RebarBarType myFirstMainRebarType = formSquareColumnsReinforcementType5.mySelectionFirstMainBarTape;
            //Выбор типа основной боковой арматуры
            RebarBarType mySecondMainRebarType = formSquareColumnsReinforcementType5.mySelectionSecondMainBarTape;
            //Выбор типа арматуры хомутов опоясывающих
            RebarBarType myFirstStirrupBarTape = formSquareColumnsReinforcementType5.mySelectionFirstStirrupBarTape;
            //Выбор типа арматуры хомутов дополнительных
            RebarBarType mySecondStirrupBarTape = formSquareColumnsReinforcementType5.mySelectionSecondStirrupBarTape;
            //Выбор типа защитного слоя основной арматуры
            RebarCoverType myRebarCoverType = formSquareColumnsReinforcementType5.mySelectionRebarCoverType;
            ...
            double floorThicknessAboveColumn = formSquareColumnsReinforcementType5.FloorThickness / 304.8;
            ...
            //Длина выпусков
            double rebarOutletsLength = formSquareColumnsReinforcementType5.RebarOutlets / 304.8;

            //Длина выпусков боковых стержней
            double rebarSecondOutletsLength = formSquareColumnsReinforcementType5.RebarSecondOutlets / 304.8;

            // Смещение первого хомута от низа колонны
            double firstStirrupOffset = formSquareColumnsReinforcementType5.FirstStirrupOffset / 304.8;

            // Учащенный шаг хомутов
            double increasedStirrupSpacing = formSquareColumnsReinforcementType5.IncreasedStirrupSpacing / 304.8;

            // Стандартный шаг хомутов
            double standardStirrupSpacing = formSquareColumnsReinforcementType5.StandardStirrupSpacing / 304.8;

            //Высота размещения хомутов с учащенным шагом
            double stirrupIncreasedPlacementHeight = formSquareColumnsReinforcementType5.StirrupIncreasedPlacementHeight / 304.8;
            int StirrupBarElemFrequentQuantity = (int)(stirrupIncreasedPlacementHeight / increasedStirrupSpacing) + 1;

            string checkedRebarOutletsButtonName = formSquareColumnsReinforcementType5.CheckedRebarOutletsButtonName;

            //Изменение сечения колонны
            bool changeColumnSection = formSquareColumnsReinforcementType5.СhangeColumnSection;
            //Переход со сварки на нахлест
            bool transitionToOverlap = formSquareColumnsReinforcementType5.TransitionToOverlap;

            //Смещение боковых стержней относительно центра колонны
            double secondLowerRebarOffset = formSquareColumnsReinforcementType5.SecondLowerRebarOffset / 304.8;
            double secondTopRebarOffset = formSquareColumnsReinforcementType5.SecondTopRebarOffset / 304.8;
            ...
            //Загнуть в плиту
            bool bendIntoASlab = formSquareColumnsReinforcementType5.BendIntoASlab;
...
#region Старт блока Получение типа элемента CIT_04_ВаннаДляСварки
            ...
            double sectionOffset = formSquareColumnsReinforcementType5.ColumnSectionOffset / 304.8;
            ...
            using (Transaction t = new Transaction(doc))
            {
                ...
                foreach (FamilyInstance myColumn in columnsList)
                {
                    ...
                    if (checkedRebarOutletsButtonName == "radioButton_MainOverlappingRods" & changeColumnSection == false & bendIntoASlab == false)
                    {
                        ...
                        Rebar columnMainRebar_1C = Rebar.CreateFromCurvesAndShape(doc, myMainRebarShapeOverlappingRods, mySecondMainRebarType, null, null, myColumn, mainRebarNormal, mySecondMainRebarCurves, RebarHookOrientation.Right, RebarHookOrientation.Right);
                        ElementTransformUtils.RotateElement(doc, columnMainRebar_1C.Id, rotateLine, 90 * (Math.PI / 180));
                        XYZ newPlaсeСolumnMainRebar_1C = new XYZ(-columnSectionHeight / 2 + mainRebarCoverLayer + secondMainRebarDiam / 2, 0, 0);
                        ...
                        XYZ newPlaсeСolumnMainRebar_2C = new XYZ(+columnSectionHeight / 2 - mainRebarCoverLayer - secondMainRebarDiam / 2, 0, 0);
                        ...
                        Rebar columnMainRebar_3C = Rebar.CreateFromCurvesAndShape(doc, myMainRebarShapeOverlappingRods, mySecondMainRebarType, null, null, myColumn, mainRebarNormal, mySecondMainRebarCurves, RebarHookOrientation.Right, RebarHookOrientation.Right);
                        XYZ newPlaсeСolumnMainRebar_3C = new XYZ(0, -columnSectionWidth / 2 + mainRebarCoverLayer + secondMainRebarDiam / 2, 0);
                        ...
                        XYZ newPlaсeСolumnMainRebar_4C = new XYZ(0, columnSectionWidth / 2 - mainRebarCoverLayer - secondMainRebarDiam / 2, 0);
                    ...
                    else if (checkedRebarOutletsButtonName == "radioButton_MainWeldingRods" & transitionToOverlap == false & changeColumnSection == false & bendIntoASlab == false)
                    {
                        ...
                        //Центральный левый стержень
                        Rebar columnMainRebar_1C = Rebar.CreateFromCurvesAndShape(doc, myMainRebarShapeWeldingRods, mySecondMainRebarType, null, null, myColumn, mainRebarNormal, myFirstMainRebarCurves, RebarHookOrientation.Right, RebarHookOrientation.Right);
                        XYZ newPlaсeСolumnMainRebar_1C = new XYZ(-columnSectionHeight / 2 + mainRebarCoverLayer + secondMainRebarDiam / 2, 0, 0);
                        ElementTransformUtils.MoveElement(doc, columnMainRebar_1C.Id, newPlaсeСolumnMainRebar_1C);
                        rebarIdCollection.Add(columnMainRebar_1C.Id);

                        FamilyInstance tubWelding_1C = doc.Create.NewFamilyInstance(firstTubWelding_p1, myTubWeldingSymbol, baseLevel, StructuralType.NonStructural);
                        ...
                        //Центральный нижний стержень
                        Rebar columnMainRebar_3C = Rebar.CreateFromCurvesAndShape(doc, myMainRebarShapeWeldingRods, mySecondMainRebarType, null, null, myColumn, mainRebarNormal, myFirstMainRebarCurves, RebarHookOrientation.Right, RebarHookOrientation.Right);
                        XYZ newPlaсeСolumnMainRebar_3C = new XYZ(0, -columnSectionWidth / 2 + mainRebarCoverLayer + secondMainRebarDiam / 2, 0);
                        ElementTransformUtils.MoveElement(doc, columnMainRebar_3C.Id, newPlaсeСolumnMainRebar_3C);
                        rebarIdCollection.Add(columnMainRebar_3C.Id);

                        FamilyInstance tubWelding_3C = doc.Create.NewFamilyInstance(firstTubWelding_p1, myTubWeldingSymbol, baseLevel, StructuralType.NonStructural);
                    ...
                    else if (checkedRebarOutletsButtonName == "radioButton_MainOverlappingRods" & changeColumnSection == true & sectionOffset <= 50 / 304.8)
                    {
                        ...
                        XYZ newPlaсeСolumnRebar_2C = new XYZ(columnSectionHeight / 2 - mainRebarCoverLayer - secondMainRebarDiam / 2, 0, 0);
                        ...
                        XYZ newPlaсeСolumnRebar_3C = new XYZ(0, -columnSectionWidth / 2 + mainRebarCoverLayer + secondMainRebarDiam / 2, 0);
                        ...
                        XYZ newPlaсeСolumnRebar_4C = new XYZ(0, columnSectionWidth / 2 - mainRebarCoverLayer - secondMainRebarDiam / 2, 0);
                    ...
                    else if (checkedRebarOutletsButtonName == "radioButton_MainWeldingRods" & transitionToOverlap == false & changeColumnSection == true & sectionOffset <= 50 / 304.8)
                    {
                        ...
                        FamilyInstance tubWelding_1C = doc.Create.NewFamilyInstance(firstTubWelding_p1, myTubWeldingSymbol, baseLevel, StructuralType.NonStructural);
                        tubWelding_1C.LookupParameter("Диаметр стержня").Set(secondMainRebarDiam);
                        XYZ newPlaсetubWelding_1C = new XYZ(-columnSectionHeight / 2 + mainRebarCoverLayer + secondMainRebarDiam / 2 + sectionOffset, 0, 0);
                        ...
                        FamilyInstance tubWelding_2C = doc.Create.NewFamilyInstance(firstTubWelding_p1, myTubWeldingSymbol, baseLevel, StructuralType.NonStructural);
                        tubWelding_2C.LookupParameter("Диаметр стержня").Set(secondMainRebarDiam);
                        XYZ newPlaсetubWelding_2C = new XYZ(columnSectionHeight / 2 - mainRebarCoverLayer - secondMainRebarDiam / 2 - sectionOffset, 0, 0);
                        ...
                        FamilyInstance tubWelding_3C = doc.Create.NewFamilyInstance(firstTubWelding_p1, myTubWeldingSymbol, baseLevel, StructuralType.NonStructural);
                        tubWelding_3C.LookupParameter("Диаметр стержня").Set(secondMainRebarDiam);
                        XYZ newPlaсetubWelding_3C = new XYZ(0, -columnSectionWidth / 2 + mainRebarCoverLayer + secondMainRebarDiam / 2 + sectionOffset, 0);
                        ...
                        FamilyInstance tubWelding_4C = doc.Create.NewFamilyInstance(firstTubWelding_p1, myTubWeldingSymbol, baseLevel, StructuralType.NonStructural);
                        tubWelding_4C.LookupParameter("Диаметр стержня").Set(secondMainRebarDiam);
                        XYZ newPlaсetubWelding_4C = new XYZ(0, columnSectionWidth / 2 - mainRebarCoverLayer - secondMainRebarDiam / 2 - sectionOffset, 0);
